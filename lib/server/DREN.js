...
const DRENjs = function DRENjs(conf) {
	...
	this.templatesConfig.templateScripts = (!Tools.isNA(conf.templatesConfig) && conf.templatesConfig.templateScripts);
	if (!check.object(this.templatesConfig.templateScripts) && !check.nonEmptyString(this.templatesConfig.templateScripts)) {
